...
We think that a lot of what makes app development hard is _managing state_: reacting and propagating changes as the user takes actions.
...
Even in our limited prototype, we've found _thinking of apps as queries_ to be a powerful frame, opening up new approaches to debugging, persistence, and cross-app interoperability.
We've also learned hard lessons about the limitations of SQL and the performance challenges of the web platform.
